...
const Contact = () => {
  ...
  return (
    <div className={`${styles.contactPage} ${animateOut ? styles.fadeOut : ''}`}>
      ...
      <div className={styles.contactInfoWrapper}>
        ...
        <div className={styles.horiDivider}></div>
          ...
          <div className={styles.right}>
            <strong className={styles.tableHead}>Hours of operation</strong>
      ...
      <div className={styles.container}>
        <div className={styles.getInTouch}>Get in <em>touch</em> with us!</div>
